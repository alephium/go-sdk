...
// checks if the TestInputAsset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestInputAsset{}
...
type _TestInputAsset TestInputAsset
...
func (o TestInputAsset) ToMap() (map[string]interface{}, error) {
...
func (o *TestInputAsset) UnmarshalJSON(data []byte) (err error) {
	...
	varTestInputAsset := _TestInputAsset{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestInputAsset)

	if err != nil {
		return err
	}

	*o = TestInputAsset(varTestInputAsset)
