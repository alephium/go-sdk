...
// checks if the FixedAssetOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FixedAssetOutput{}
...
type _FixedAssetOutput FixedAssetOutput
...
func (o FixedAssetOutput) ToMap() (map[string]interface{}, error) {
...
func (o *FixedAssetOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varFixedAssetOutput := _FixedAssetOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFixedAssetOutput)

	if err != nil {
		return err
	}

	*o = FixedAssetOutput(varFixedAssetOutput)
