...
// checks if the BuildExecuteScriptTxResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildExecuteScriptTxResult{}
...
func (o BuildExecuteScriptTxResult) ToMap() (map[string]interface{}, error) {
