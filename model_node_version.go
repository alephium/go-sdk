...
func (o *NodeVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeVersion := _NodeVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeVersion)

	if err != nil {
		return err
	}

	*o = NodeVersion(varNodeVersion)
