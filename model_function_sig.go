...
func (o *FunctionSig) UnmarshalJSON(data []byte) (err error) {
	...
	varFunctionSig := _FunctionSig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFunctionSig)

	if err != nil {
		return err
	}

	*o = FunctionSig(varFunctionSig)
