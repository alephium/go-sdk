...
type _MinerAddressesInfo MinerAddressesInfo
...
func (o *MinerAddressesInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varMinerAddressesInfo := _MinerAddressesInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMinerAddressesInfo)

	if err != nil {
		return err
	}

	*o = MinerAddressesInfo(varMinerAddressesInfo)
