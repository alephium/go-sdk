...
*BlockflowApi* | [**GetBlockflow**](docs/BlockflowApi.md#getblockflow) | **Get** /blockflow | List blocks on the given time interval
...
*EventsApi* | [**GetEventsTxIdTxid**](docs/EventsApi.md#geteventstxidtxid) | **Get** /events/tx-id/{txId} | Get events for a TxScript
