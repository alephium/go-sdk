...
// checks if the ReleaseVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseVersion{}
...
func (o ReleaseVersion) ToMap() (map[string]interface{}, error) {
