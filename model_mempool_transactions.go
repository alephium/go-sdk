...
type _MempoolTransactions MempoolTransactions
...
func (o *MempoolTransactions) UnmarshalJSON(data []byte) (err error) {
	...
	varMempoolTransactions := _MempoolTransactions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMempoolTransactions)

	if err != nil {
		return err
	}

	*o = MempoolTransactions(varMempoolTransactions)
