...
type CompileContractResult struct {
	...
	Maps *MapsSig `json:"maps,omitempty"`
	StdInterfaceId *string `json:"stdInterfaceId,omitempty"`
}

type _CompileContractResult CompileContractResult
...
// SetMaps gets a reference to the given MapsSig and assigns it to the Maps field.
...
func (o *CompileContractResult) UnmarshalJSON(data []byte) (err error) {
	...
	varCompileContractResult := _CompileContractResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCompileContractResult)

	if err != nil {
		return err
	}

	*o = CompileContractResult(varCompileContractResult)
