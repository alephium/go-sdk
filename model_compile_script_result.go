...
type _CompileScriptResult CompileScriptResult
...
func (o *CompileScriptResult) UnmarshalJSON(data []byte) (err error) {
	...
	varCompileScriptResult := _CompileScriptResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCompileScriptResult)

	if err != nil {
		return err
	}

	*o = CompileScriptResult(varCompileScriptResult)
