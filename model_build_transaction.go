...
// checks if the BuildTransaction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildTransaction{}
...
func (o BuildTransaction) ToMap() (map[string]interface{}, error) {
