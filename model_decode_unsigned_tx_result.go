...
type _DecodeUnsignedTxResult DecodeUnsignedTxResult
...
func (o *DecodeUnsignedTxResult) UnmarshalJSON(data []byte) (err error) {
	...
	varDecodeUnsignedTxResult := _DecodeUnsignedTxResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDecodeUnsignedTxResult)

	if err != nil {
		return err
	}

	*o = DecodeUnsignedTxResult(varDecodeUnsignedTxResult)
