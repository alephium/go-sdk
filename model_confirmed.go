...
// checks if the Confirmed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Confirmed{}
...
func (o Confirmed) ToMap() (map[string]interface{}, error) {
...
func (o *Confirmed) UnmarshalJSON(data []byte) (err error) {
	...
	varConfirmed := _Confirmed{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfirmed)

	if err != nil {
		return err
	}

	*o = Confirmed(varConfirmed)
