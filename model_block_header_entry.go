...
// checks if the BlockHeaderEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockHeaderEntry{}
...
type _BlockHeaderEntry BlockHeaderEntry
...
func (o BlockHeaderEntry) ToMap() (map[string]interface{}, error) {
...
func (o *BlockHeaderEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varBlockHeaderEntry := _BlockHeaderEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBlockHeaderEntry)

	if err != nil {
		return err
	}

	*o = BlockHeaderEntry(varBlockHeaderEntry)
