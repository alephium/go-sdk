...
func (o *PeerAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varPeerAddress := _PeerAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPeerAddress)

	if err != nil {
		return err
	}

	*o = PeerAddress(varPeerAddress)
