...
type _BrokerInfoAddress BrokerInfoAddress
...
func (o *BrokerInfoAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varBrokerInfoAddress := _BrokerInfoAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBrokerInfoAddress)

	if err != nil {
		return err
	}

	*o = BrokerInfoAddress(varBrokerInfoAddress)
