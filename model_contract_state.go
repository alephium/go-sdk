...
type _ContractState ContractState
...
func (o *ContractState) UnmarshalJSON(data []byte) (err error) {
	...
	varContractState := _ContractState{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContractState)

	if err != nil {
		return err
	}

	*o = ContractState(varContractState)
