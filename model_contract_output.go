...
// checks if the ContractOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContractOutput{}
...
type _ContractOutput ContractOutput
...
func (o ContractOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ContractOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varContractOutput := _ContractOutput{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varContractOutput)

	if err != nil {
		return err
	}

	*o = ContractOutput(varContractOutput)
