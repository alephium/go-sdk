...
func (o *ValAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varValAddress := _ValAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varValAddress)

	if err != nil {
		return err
	}

	*o = ValAddress(varValAddress)
