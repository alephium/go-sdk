...
type _CallContractSucceeded CallContractSucceeded
...
func (o *CallContractSucceeded) UnmarshalJSON(data []byte) (err error) {
	...
	varCallContractSucceeded := _CallContractSucceeded{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCallContractSucceeded)

	if err != nil {
		return err
	}

	*o = CallContractSucceeded(varCallContractSucceeded)
