...
type _InterCliquePeerInfo InterCliquePeerInfo
...
func (o *InterCliquePeerInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varInterCliquePeerInfo := _InterCliquePeerInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInterCliquePeerInfo)

	if err != nil {
		return err
	}

	*o = InterCliquePeerInfo(varInterCliquePeerInfo)
