...
type _BlocksPerTimeStampRange BlocksPerTimeStampRange
...
func (o *BlocksPerTimeStampRange) UnmarshalJSON(data []byte) (err error) {
	...
	varBlocksPerTimeStampRange := _BlocksPerTimeStampRange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBlocksPerTimeStampRange)

	if err != nil {
		return err
	}

	*o = BlocksPerTimeStampRange(varBlocksPerTimeStampRange)
