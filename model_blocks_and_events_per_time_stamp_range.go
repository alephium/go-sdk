...
type _BlocksAndEventsPerTimeStampRange BlocksAndEventsPerTimeStampRange
...
func (o *BlocksAndEventsPerTimeStampRange) UnmarshalJSON(data []byte) (err error) {
	...
	varBlocksAndEventsPerTimeStampRange := _BlocksAndEventsPerTimeStampRange{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBlocksAndEventsPerTimeStampRange)

	if err != nil {
		return err
	}

	*o = BlocksAndEventsPerTimeStampRange(varBlocksAndEventsPerTimeStampRange)
