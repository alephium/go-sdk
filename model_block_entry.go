...
// checks if the BlockEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockEntry{}
...
func (o BlockEntry) ToMap() (map[string]interface{}, error) {
...
func (o *BlockEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varBlockEntry := _BlockEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBlockEntry)

	if err != nil {
		return err
	}

	*o = BlockEntry(varBlockEntry)
