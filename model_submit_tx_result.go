...
// checks if the SubmitTxResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubmitTxResult{}
...
type _SubmitTxResult SubmitTxResult
...
func (o SubmitTxResult) ToMap() (map[string]interface{}, error) {
...
func (o *SubmitTxResult) UnmarshalJSON(data []byte) (err error) {
	...
	varSubmitTxResult := _SubmitTxResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubmitTxResult)

	if err != nil {
		return err
	}

	*o = SubmitTxResult(varSubmitTxResult)
