...
type _WalletRestore WalletRestore
...
func (o *WalletRestore) UnmarshalJSON(data []byte) (err error) {
	...
	varWalletRestore := _WalletRestore{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWalletRestore)

	if err != nil {
		return err
	}

	*o = WalletRestore(varWalletRestore)
