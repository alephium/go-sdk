...
type _MultipleCallContract MultipleCallContract
...
func (o *MultipleCallContract) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipleCallContract := _MultipleCallContract{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipleCallContract)

	if err != nil {
		return err
	}

	*o = MultipleCallContract(varMultipleCallContract)
