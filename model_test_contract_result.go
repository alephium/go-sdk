...
type _TestContractResult TestContractResult
...
func (o *TestContractResult) UnmarshalJSON(data []byte) (err error) {
	...
	varTestContractResult := _TestContractResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestContractResult)

	if err != nil {
		return err
	}

	*o = TestContractResult(varTestContractResult)
