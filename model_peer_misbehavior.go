...
type _PeerMisbehavior PeerMisbehavior
...
func (o *PeerMisbehavior) UnmarshalJSON(data []byte) (err error) {
	...
	varPeerMisbehavior := _PeerMisbehavior{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPeerMisbehavior)

	if err != nil {
		return err
	}

	*o = PeerMisbehavior(varPeerMisbehavior)
