...
type _DebugMessage DebugMessage
...
func (o *DebugMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varDebugMessage := _DebugMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDebugMessage)

	if err != nil {
		return err
	}

	*o = DebugMessage(varDebugMessage)
