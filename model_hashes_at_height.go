...
// checks if the HashesAtHeight type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HashesAtHeight{}
...
type _HashesAtHeight HashesAtHeight
...
func (o HashesAtHeight) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["headers"] = o.Headers
	return toSerialize, nil
}

func (o *HashesAtHeight) UnmarshalJSON(data []byte) (err error) {
	...
	varHashesAtHeight := _HashesAtHeight{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHashesAtHeight)

	if err != nil {
		return err
	}

	*o = HashesAtHeight(varHashesAtHeight)
