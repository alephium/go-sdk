...
// checks if the UnsignedTx type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnsignedTx{}
...
func (o UnsignedTx) ToMap() (map[string]interface{}, error) {
...
func (o *UnsignedTx) UnmarshalJSON(data []byte) (err error) {
	...
	varUnsignedTx := _UnsignedTx{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUnsignedTx)

	if err != nil {
		return err
	}

	*o = UnsignedTx(varUnsignedTx)
