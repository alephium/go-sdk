...
// checks if the ChainParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChainParams{}
...
func (o ChainParams) ToMap() (map[string]interface{}, error) {
...
func (o *ChainParams) UnmarshalJSON(data []byte) (err error) {
	...
	varChainParams := _ChainParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChainParams)

	if err != nil {
		return err
	}

	*o = ChainParams(varChainParams)
