...
type _CallContractFailed CallContractFailed
...
func (o *CallContractFailed) UnmarshalJSON(data []byte) (err error) {
	...
	varCallContractFailed := _CallContractFailed{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCallContractFailed)

	if err != nil {
		return err
	}

	*o = CallContractFailed(varCallContractFailed)
