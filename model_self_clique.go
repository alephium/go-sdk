...
// checks if the SelfClique type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SelfClique{}
...
func (o SelfClique) ToMap() (map[string]interface{}, error) {
...
func (o *SelfClique) UnmarshalJSON(data []byte) (err error) {
	...
	varSelfClique := _SelfClique{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSelfClique)

	if err != nil {
		return err
	}

	*o = SelfClique(varSelfClique)
