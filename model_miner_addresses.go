...
// checks if the MinerAddresses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MinerAddresses{}
...
type _MinerAddresses MinerAddresses
...
func (o MinerAddresses) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["addresses"] = o.Addresses
	return toSerialize, nil
}

func (o *MinerAddresses) UnmarshalJSON(data []byte) (err error) {
	...
	varMinerAddresses := _MinerAddresses{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMinerAddresses)

	if err != nil {
		return err
	}

	*o = MinerAddresses(varMinerAddresses)
