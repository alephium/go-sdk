...
// checks if the CallContractResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallContractResult{}
...
func (o CallContractResult) ToMap() (map[string]interface{}, error) {
