...
// checks if the BuildDeployContractTxResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildDeployContractTxResult{}
...
func (o BuildDeployContractTxResult) ToMap() (map[string]interface{}, error) {
