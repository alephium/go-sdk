...
type _MultipleCallContractResult MultipleCallContractResult
...
func (o *MultipleCallContractResult) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipleCallContractResult := _MultipleCallContractResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipleCallContractResult)

	if err != nil {
		return err
	}

	*o = MultipleCallContractResult(varMultipleCallContractResult)
