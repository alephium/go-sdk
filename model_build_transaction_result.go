...
// checks if the BuildTransactionResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BuildTransactionResult{}
...
func (o BuildTransactionResult) ToMap() (map[string]interface{}, error) {
